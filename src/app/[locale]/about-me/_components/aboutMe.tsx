...
const AboutMe = () => {
  ...
  useEffect(() => {
    const refsAnimationArray = [titleRef.current, paragraph1Ref.current, paragraph2Ref.current, paragraph3Ref.current, paragraph4Ref.current, cardRef.current, cardRef2.current];
  ...
  return (
    <main className="pb-6 flex flex-col items-start space-y-6 pt-16 px-5 sm:flex sm:justify-between md:gap-8 md:p-10 lg:p-20 lg:pt-28 lg:flex-row xl:px-40 2xl:px-80 2xl:pt-80 h-full">
      ...
      <div className="w-full flex flex-col gap-4">
        <Card className="w-full p-4 md:p-6 md:w-[280px] flex justify-center items-center opacity-0" aria-label="card" ref={cardRef}>
        ...
        <Card className="w-full p-4 md:p-6 md:w-[280px] flex justify-center items-center opacity-0" aria-label="card" ref={cardRef2}>
          <CardContent className="w-full py-2 space-y-6 h-full justify-between flex flex-col">
